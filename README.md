...
- **[mattpocock/skills](https://github.com/mattpocock/skills)**：本仓库软件工程 skill 的上游。软件工程部分的 skill 对齐该项目当前版本、翻译成中文；自创 skill（`sync-writing-standards`、`loop-go`、`setup-ouyangjiahong-skills`）为本仓库独有。
